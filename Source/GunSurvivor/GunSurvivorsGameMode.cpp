...
{
	GetWorldTimerManager().SetTimer(RestartGameTimer, this, &AGunSurvivorsGameMode::OnRestartGaemTimerTimeout, 1.0f, false, TimeBeforeRestart);
}
void AGunSurvivorsGameMode::OnRestartGaemTimerTimeout()
{
